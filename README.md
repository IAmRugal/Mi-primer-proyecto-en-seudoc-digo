...
Algoritmo CondicionalSi_Sino
	...
	Escribir "Registre el primer número."
	Leer Num1
	Escribir "Registre el segundo número."
	Leer Num2
	Si (Num1 > Num2) Entonces
		Escribir "El primer número es mayor: ", Num1
	SiNo 
		Si (Num1 = Num2) Entonces
		Escribir "Los dos números son iguales: ", Num1
	    SiNo
			Escribir "El segundo número es mayor: ", Num2
		FinSi
	FinSi
FinAlgoritmo
